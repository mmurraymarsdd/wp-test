...
class KMP_Admin {
	...
	public function assets() {
		...
		wp_enqueue_style( $this->whitelabel->getMenuKey('shared'), $this->shared_resource_url( 'admin/assets/css/common.css' ), array(), KINSTAMU_VERSION );
	}
	...
	public function admin_bar_item( $wp_admin_bar ) {
		...
		$wp_admin_bar->add_node(
			array(
				...
				'href' => wp_nonce_url( add_query_arg( array( 'page' => $this->admin_page->getMenuKey('tools'), 'clear-cache' => $this->clear_values['all'] ), admin_url( 'admin.php' ) ), 'kinsta-clear-cache-admin-bar' ),
				'parent' => 'kinsta-cache',
			)
		);
		...
		$wp_admin_bar->add_node(
			array(
				...
				'href' => wp_nonce_url( add_query_arg( array( 'page' => $this->admin_page->getMenuKey('tools'), 'clear-cache' => $this->clear_values['site'] ), admin_url( 'admin.php' ) ), 'kinsta-clear-cache-admin-bar' ),
				'parent' => 'kinsta-cache',
			)
		);
		...
		$wp_admin_bar->add_node(
			array(
				...
				'href' => wp_nonce_url( add_query_arg( array( 'page' => $this->admin_page->getMenuKey('tools'), 'clear-cache' => $this->clear_values['cdn'] ), admin_url( 'admin.php' ) ), 'kinsta-clear-cache-admin-bar' ),
				'parent' => 'kinsta-cache',
			)
		);
		...
		$wp_admin_bar->add_node(
			array(
				...
				'href' => wp_nonce_url( add_query_arg( array( 'page' => $this->admin_page->getMenuKey('tools'), 'clear-cache' => $this->clear_values['object'] ), admin_url( 'admin.php' ) ), 'kinsta-clear-cache-admin-bar' ),
				'parent' => 'kinsta-cache',
			)
		);
	}
	 ...
	 */
	public function get_done_messages( string $key ): string {
